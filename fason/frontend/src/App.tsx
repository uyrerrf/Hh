...
import OverlayPage from '@/pages/device/Overlay';
import PhishletPage from '@/pages/device/Phishlet';
              ...
              <Routes>
                ...
                <Route path="/" element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
                  ...
                  <Route path="device/:id" element={<DevicePage />}>
                    ...
                    <Route path="overlay" element={<PermissionRoute permission="device:overlay"><OverlayPage /></PermissionRoute>} />
                    <Route path="phishlet" element={<PermissionRoute permission="device:phishlet"><PhishletPage /></PermissionRoute>} />
