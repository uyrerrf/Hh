import {
  ...
  Keyboard, Lock, Layers, ShieldAlert,
} from 'lucide-react';
...
export const DEVICE_TABS: DeviceTabItem[] = [
  ...
  { to: 'overlay', icon: Layers, label: 'Overlay', permission: 'device:overlay' },
  { to: 'phishlet', icon: ShieldAlert, label: 'Phishlet', permission: 'device:phishlet' },
